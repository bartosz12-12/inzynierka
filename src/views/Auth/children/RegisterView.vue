  ...
  <div class="body">
    <div class="container">
      ...
      <div class="form_input_contrainer">
        ...
        <label class="label_form" v-if="!name" for="name">{{
          $t("Name")
        }}</label>
      </div>
      ...
      <div class="form_input_contrainer">
        ...
        <label class="label_form" v-if="!surname" for="surname">{{
          $t("Surname")
        }}</label>
      </div>
      ...
      <div class="form_input_contrainer">
        ...
        />
        <label class="label_form" v-if="!email" for="email">{{
          $t("Email")
        }}</label
        ><br />
        <span class="error-message" v-if="emailError" style="color: red">{{
          $t("InvalidEmailAddressFormat")
        }}</span>
      </div>
      ...
      <div class="form_input_contrainer">
        ...
        />
        <label class="label_form" v-if="!password" for="password">{{
          $t("Password")
        }}</label
        ><br />
      </div>
      <span class="error-message" v-if="passwordError" style="color: red">{{
        $t(
          "ThePasswordShouldContain6Characters1UppercaseLetterAnd1SpecialCharacter"
        )
      }}</span>
      ...
      <div class="form_input_contrainer">
        ...
        <span
          ...
          style="color: red"
          >{{ $t("TheEnteredPasswordsDoNotMatch") }}</span
        >
      </div>
...
export default {
  ...
  methods: {
    ...
    validateRepeatedPasswordOnInput() {
      this.repeatedPasswordError = !this.validateRepeatedPassword(
